...
(yas-define-snippets 'lisp-mode
                     '(("typecast" "(coerce ${1:object} ${2:type})\n$0\n" "cast"
                        nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/typecast"
                        nil nil)
                       ("slot"
                        ...
                        "slot" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/slot"
                        nil nil)
                       ("ifnot"
                        "(unless (${1:condition})\n        (${2:then-do-this}))\n$0\n"
                        "ifnot (...) (...)  ..." nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/ifnot"
                        nil nil)
                       ("ifelse"
                        "(if (${1:condition})\n    (${2:then})\n    (${3:else}))\n$0\n"
                        "ifelse (...) (...) (...) ..." nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/ifelse"
                        nil nil)
                       ("if"
                        "(when (${1:condition})\n      (${2:then-do-this}))\n$0\n"
                        "if" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/if" nil
                        nil)
                       ("print" "(format t \"~& $0 ~%\")\n" "format" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/format"
                        nil nil)
                       ("foreach"
                        "(dolist (${1:var} ${2:list-form})\n        ${3:body})\n$0\n"
                        "do" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/foreach"
                        nil nil)
                       ("for"
                        "(dotimes (${1:var} ${2:count-form})\n         ${3:body})\n$0\n"
                        "do" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/for" nil
                        nil)
                       ("do"
                        "(do ((${1:var1} ${2:init-form} ${3:step-form})\n     (${4:var2} ${5:init-form} ${6:step-form}))\n    (${7:condition} ${8:return-value})\n    (${9:body}))\n$0\n"
                        "do" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/do" nil
                        nil)
                       ("defp"
                        "(defpackage #:${1:name}\n   (:nicknames #:${2:nick})\n   (:use #:cl #:closer-mop #:${3:package})\n   (:shadow :${4.symbol})\n   (:shadowing-import-from #:${5:package} #:${6:symbol})\n   (:export :$0))\n"
                        "defpackage" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/defpackage"
                        nil nil)
                       ("cond"
                        "(cond (${1:case1} (${2:do-this}))\n      (${3:case2} (${4:do-this}))\n      (t ${5:default}))\n$0\n"
                        "cond" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/cond"
                        nil nil)
                       ("/*" "#|${1:type the comment here}|#\n$0\n" "comment"
                        nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/comment"
                        nil nil)
                       ("cls"
                        "(defclass ${1:name} (${2:inherits})\n   (${4:slot})\n   (:documentation \"${3:doc}\"))\n$0\n"
                        "class" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/lisp-mode/class"
                        nil nil)))
