...
(yas-define-snippets 'prog-mode
                     '(("x" "`comment-start`XXX: $0`comment-end`" "xxx" nil nil
                        nil "/Users/liyuan/.config/emacs/snippets/prog-mode/xxx"
                        nil nil)
                       ("t" "`comment-start`TODO: $0`comment-end`" "todo" nil
                        nil nil
                        "/Users/liyuan/.config/emacs/snippets/prog-mode/todo"
                        nil nil)
                       ("fi" "`comment-start`FIXME: $0`comment-end`" "fixme"
                        (not (eq major-mode 'sh-mode)) nil nil
                        "/Users/liyuan/.config/emacs/snippets/prog-mode/fixme"
                        nil nil)
                       ("col"
                        ...
                        "commentline" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/prog-mode/commentline"
                        nil nil)
                       ("cob"
                        ...
                        "/Users/liyuan/.config/emacs/snippets/prog-mode/commentblock"
                        nil nil)
                       ("co"
                        "`(yas-trimmed-comment-start)` ${1:comment}`(unless (eq (length comment-end) 0) (concat \" \" (yas-trimmed-comment-end)))`$0"
                        "comment" nil nil nil
                        "/Users/liyuan/.config/emacs/snippets/prog-mode/comment"
                        nil nil)))
